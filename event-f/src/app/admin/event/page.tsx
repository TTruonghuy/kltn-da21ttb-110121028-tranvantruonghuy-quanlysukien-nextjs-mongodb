...
type FilterTab = "approval" | "selling" | "past";
                ...
                {statMode ? (
                    ...
                    <>
                        ...
                        <div className="flex gap-4 mb-4">
                            <button
                                className={`px-4 py-2 rounded-lg ${activeTab === "approval" ? "bg-blue-200 font-bold" : "bg-white"}`}
                                onClick={() => setActiveTab("approval")}
                            >
                                Chờ duyệt ({counts.approval})
                            </button>
                            <button
                                className={`px-4 py-2 rounded-lg ${activeTab === "selling" ? "bg-blue-200 font-bold" : "bg-white"}`}
                                onClick={() => setActiveTab("selling")}
                            >
                                Đang bán vé ({counts.selling})
                            </button>
                            <button
                                className={`px-4 py-2 rounded-lg ${activeTab === "past" ? "bg-blue-200 font-bold" : "bg-white"}`}
                                                            ...
                                                            <div>
                                                                <ul>
                                                                    {event.sessions.map((s) => (
                                                                        <li key={s._id}>
                                                                            <b>Session:</b>  {new Date(s.start_time).toLocaleString("vi-VN")} - {new Date(s.end_time).toLocaleString("vi-VN")}
                                                                            <ul>
                                                                                {s.tickets.map((t, idx) => (
                                                                                    <li key={idx}
                                                                                        className="pl-2">
